...
public class JwtUtil {
     ...
     * </p>
     *
     * <p><b>WARNING: 서명 미검증 메서드입니다.</b><br>
     * 이 메서드는 JWT 서명을 검증하지 않으므로, 반환된 클레임은 위·변조 여부를 보증할 수 없습니다.
     * <b>인가(Authorization) 결정의 입력값으로 절대 사용해서는 안 됩니다.</b><br>
     * 반드시 Keycloak Introspect 또는 JWKS 서명 검증과 쌍으로만 사용해야 합니다.
     * 즉, 이 메서드로 추출한 클레임은 <em>서버에서 독립적으로 신뢰하는 용도(예: 권한 부여, 접근 제어)</em>로
     * 사용할 수 없으며, Keycloak 검증 성공 이후 식별자·UI 표시 등 보조 용도로만 사용해야 합니다.
     * </p>
     *
